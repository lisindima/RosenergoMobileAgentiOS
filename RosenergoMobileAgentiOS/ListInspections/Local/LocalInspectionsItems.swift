    ...
    var body: some View {
        HStack {
            ...
            if !localInspections.photos!.isEmpty {
                Image(uiImage: UIImage(data: Data(base64Encoded: localInspections.photos!.first!, options: .ignoreUnknownCharacters)!)!.resizedImage(size: CGSize(width: 100, height: 100)))
                    .resizable()
                    .cornerRadius(10)
