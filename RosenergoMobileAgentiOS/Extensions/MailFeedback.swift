...
struct MailFeedback: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: UIViewControllerRepresentableContext<MailFeedback>) -> MFMailComposeViewController {
        ...
        mailFeedback.setMessageBody("Добрый день!<br><br>Модель устройства: <b>\(deviceInfo.modelDevice.rawValue)</b><br>Версия системы: <b>\(deviceInfo.systemName) \(deviceInfo.systemVersion)</b><br>Версия приложения: <b>\(version) (\(build))</b><br><br>Опишите, какая ошибка произошла в приложении:", isHTML: true)
